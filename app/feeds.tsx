            ...
            <View>
                <View className='w-full flex flex-row  bg-gray-200 rounded-md'>
                    <View className='flex-1 flex items-center justify-center bg-gray-200 h-10 rounded-md '>
                        <Text className='text-primary font-semibold'>Transaction</Text>
                    </View>

                    <View className='flex-1 flex items-center justify-center bg-primary h-10 rounded-md '>
                        <Text className='text-secondary font-semibold'>Feeds</Text>
                    </View>
                </View>
                ...
                <View className='flex flex-col space-y-2 my-5 '>
                    <View className='bg-secondary border border-gray-200 flex flex-row items-center px-[19px] py-[17px] space-x-[9px] rounded-md '>
                        ...
                        <View className='flex flex-col '>
                            <Text className='text-primary text-[11px] font-bold'>Your Failed transaction is being processed</Text>
                            <Text className='text-gray-500 text-[8px]'>Kindly give us 3day more.</Text>
                        </View>
                    </View>
                    <View className='bg-secondary border border-gray-200 flex flex-row items-center px-[19px] py-[17px] space-x-[9px] rounded-md '>
                        <FontAwesome6 name="briefcase" size={24} color="#40196D" />
                        <View className='flex flex-col '>
                            <Text className='text-primary text-[11px] font-bold'>Profile Updates!</Text>
                    ...
                    <View className='bg-secondary border border-gray-200 flex flex-row items-center px-[19px] py-[17px] space-x-[9px] rounded-md '>
                        <FontAwesome6 name="briefcase" size={24} color="#40196D" />
                        <View className='flex flex-col '>
                            <Text className='text-primary text-[11px] font-bold'>Kindly check to upload your information</Text>
                            <Text className='text-gray-500 text-[8px]'>25th June 2021</Text>
                        </View>
                    </View>
                    <View className='bg-secondary border border-gray-200 flex flex-row items-center px-[19px] py-[17px] space-x-[9px] rounded-md '>
                        <FontAwesome6 name="briefcase" size={24} color="#40196D" />
                        <View className='flex flex-col '>
                            <Text className='text-primary text-[11px] font-bold'>BVN details Verified</Text>
                            <Text className='text-gray-500 text-[8px]'>25th June 2021</Text>
                        </View>
                    </View>
                </View>
